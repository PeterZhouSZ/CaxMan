...
void usage()
{
	...
	printf("Usage: STL2CLI inmeshfile outcli -l val [-q val]\n");
	printf("  Processes 'inmeshfile' and saves the result to 'outcli'\n");
	...
	printf("  Example: STL2CLI inmeshfile outcli -l 0.02 -q 0.01\n");
