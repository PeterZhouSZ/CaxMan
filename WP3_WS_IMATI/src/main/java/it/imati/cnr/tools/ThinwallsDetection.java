 ...
 * @author daniela
 */
public class ThinwallsDetection 
{
    static String toolPath  = "/root/thinwalls_and_cavities/build/thinwalls_and_cavities";
    ...
    int run (String in_filename, String out_filename) throws IOException, InterruptedException
    {
        //////////////////////////////////////////////////////////////////////////////////
            // thinwalls Detection
            String cmd = toolPath + " --thinwalls --input " + in_filename + " --output " + out_filename;
