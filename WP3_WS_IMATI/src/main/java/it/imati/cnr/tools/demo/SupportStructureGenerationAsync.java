 ...
 * @author daniela
 */
@WebService(serviceName = "SupportStructureGenerationAsyncService")
public class SupportStructureGenerationAsync 
{
     ...
     * @param status_base64
     */
    @WebMethod(operationName = "SupportStructureGenerationMethod") ///////////////// UPDATE WITH YOUR NAME AND PARAMETERS
    public void support_structures_async(
    ...
    // services to look into this folder to check up on the correct running application.
        ...
        String outputURI = "swift://caxman/imati-ge/output_upports_" + sdate + ".off";   ///////////////// UPDATE WITH YOURS
        ...
        try {
            ...
            String applicationFileName = "/usr/local/bin/asyncStarter_supports.sh";
    ...
    public void getServiceStatus_supports(
            @WebParam(name = "serviceID",
                    targetNamespace = namespace, 
                    mode = WebParam.Mode.IN) String serviceID,
            @WebParam(name = "sessionToken",
