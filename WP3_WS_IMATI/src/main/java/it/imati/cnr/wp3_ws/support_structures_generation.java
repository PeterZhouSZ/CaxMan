...
public class support_structures_generation 
{
                      ...
                      mode            = WebParam.Mode.OUT)  Holder<String> annotated_tessellation_URI_out)
    {
        try
        {
            ...
            String pathSupportStructuresTool = "/root/CaxMan/support_structures/build/";
            ...
            String cmdRunSupportStructures = pathSupportStructuresTool + "support_structures " + downloadedFilename + " " + supportStructuresFilename;
            
            System.out.print("[RUNNING] : " + cmdRunSupportStructures);
            
            Process p2 = Runtime.getRuntime().exec(cmdRunSupportStructures);

            p2.waitFor();   // wait the process to finish its task
            
            System.out.print("[COMPLETED] : " + cmdRunSupportStructures);
