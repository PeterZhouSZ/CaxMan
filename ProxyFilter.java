...
package no.sintef.syncserviceskeleton;
...
public class ProxyFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, ServletResponse response,
        ...
        // In the example below, the server is behind "/sintef/" in the forwarding proxy.
        ...
        if ( internalRequest ) {
            newResponse = wrapper.toString()
                    .replace("http://api.caxman.eu:80/", "http://api.caxman.eu:80/cnr/")
                    .replace("http://api.caxman.eu:443/", "http://api.caxman.eu:443/cnr/")
                    .replace("http://api.caxman.eu/", "http://api.caxman.eu/cnr/");
            log("\n\t\t\tINTERNAL REQUEST!!!!\n\n");
        ...
        // If the request is external, your wsdl needs to use https:// protocol    
            ...
            newResponse = wrapper.toString()
                    ...
                    .replace("http://api.caxman.eu:80/", "https://api.caxman.eu:443/")
                    .replace("https://api.caxman.eu:443/", "https://api.caxman.eu:443/cnr/")
                    .replace("https://api.caxman.eu/", "https://api.caxman.eu/cnr/");
        }
